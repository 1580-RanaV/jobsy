...
export default function LandingPage() {
  ...
  return (
    <div className="bg-white font-inter">
      {/* Navigation */}
      <nav className={`bg-white/95 backdrop-blur-sm fixed w-full top-0 z-50 border-b transition-all duration-300 ${isScrolled ? 'border-black shadow-lg' : 'border-gray-200'}`}>
      ...
      <section className="pt-32 pb-32 px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-6xl mx-auto">
            <h1 className="text-7xl md:text-9xl font-bold tracking-tighter text-black mb-8 leading-none">
              Never Miss<br/>
              <span className="">
                A Job Deadline
              </span><br/>
            ...
            <p className="text-xl md:text-xl text-gray-600 mb-16 tracking-tighter font-medium max-w-5xl mx-auto leading-tight">
              Paste any job link — Get smart reminders — Land your dream job
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-24">
              <Link href="/home">
                <button className="bg-black text-white px-12 py-5 rounded-full font-medium text-xl tracking-tighter hover:bg-gray-800 transition-all duration-200 border-2 border-black transform hover:scale-105">
                  Start tracking jobs
                </button>
              </Link>
              <button className="border-2 border-black text-black px-12 py-5 rounded-full font-medium text-xl tracking-tighter hover:bg-black hover:text-white transition-all duration-200">
                See demo
              </button>
            </div>
              ...
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="rounded-3xl bg-neutral-950 p-10 text-white shadow-2xl ring-1 ring-white/10">
                  ...
                  <div className="mb-8 flex items-center justify-between">
                    ...
                    <span className="rounded-full bg-white/10 px-4 py-2 text-xs font-semibold">No accounts • No servers</span>
                  </div>
    ...
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="lg:col-span-2 rounded-3xl bg-neutral-950 p-12 text-white shadow-2xl ring-1 ring-white/10">
        ...
        <p className="mb-8 max-w-3xl text-base font-medium text-neutral-200">
          Copy any job posting URL and add it to Jobsy. We extract company, role, salary, experience, and deadline from major job sites and company career pages.
        </p>
      ...
      <div className="rounded-3xl bg-neutral-950 p-12 text-white shadow-2xl ring-1 ring-white/10">
        ...
        <p className="mb-6 text-base font-medium text-neutral-200">
          See due-soon and overdue banners whenever you visit. Enable browser notifications to get reminded one day before deadlines.
        </p>
      ...
      >
        ...
        <p className="mb-8 max-w-3xl text-base font-medium text-neutral-200">
          Your application data stays on your device. No accounts, no cloud sync, no data mining. Update status with one click and keep a clean audit trail.
        </p>
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
              ...
              <div className="rounded-2xl bg-white/[0.03] p-6 ring-1 ring-white/10">
                ...
                <p className="mb-6 text-sm font-medium text-neutral-200">
                  Most job boards just show listings. Jobsy reads the posting and extracts the details you need — company,
                  role, salary range, experience, and deadlines — so your table stays clean and consistent.
                </p>
                <ul className="space-y-2 text-sm text-neutral-200">
                  <li className="flex items-start gap-3">
                    <span className="mt-1 h-1.5 w-1.5 rounded-full bg-white" />
                ...
                <div className="space-y-4">
                  <div className="rounded-xl bg-white/[0.04] p-5 ring-1 ring-white/10">
                    ...
                    <div className="text-sm font-bold">
                      Google • Software Engineer • $140k–$180k • Due: Dec 15
                    </div>
                  </div>
                  <div className="rounded-xl bg-white/[0.04] p-5 ring-1 ring-white/10">
                    <div className="mb-2 text-xs font-semibold text-neutral-300">Detected from job posting</div>
                    <div className="text-sm font-bold">
                      Netflix • Product Manager • $160k–$220k • Due: Dec 20
                    </div>
                  </div>
                  <div className="rounded-xl bg-white/[0.04] p-5 ring-1 ring-white/10">
                    <div className="mb-2 text-xs font-semibold text-neutral-300">Detected from job posting</div>
                    <div className="text-sm font-bold">
                      Stripe • Design Lead • $150k–$200k • Due: Dec 18
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
              ...
              <div className="order-1 rounded-2xl bg-white/[0.03] p-6 ring-1 ring-white/10 lg:order-2">
                ...
                <p className="mb-6 text-sm font-medium text-neutral-200">
                  Other trackers mine your data. Jobsy stores everything locally in your browser — no servers, no accounts,
                  no tracking. Your information stays on your device and is always portable.
                </p>
                <ul className="space-y-2 text-sm text-neutral-200">
                  <li className="flex items-start gap-3">
                    <span className="mt-1 h-1.5 w-1.5 rounded-full bg-white" />
            ...
            <div className="group rounded-2xl bg-white/[0.03] p-6 ring-1 ring-white/10 transition-transform duration-300 hover:-translate-y-1">
              <div className="mb-6 flex items-center justify-between">
                <div className="inline-flex items-center gap-3">
                  ...
                  <h3 className="text-2xl font-bold leading-tight">Import & <br></br>restore</h3>
                </div>
              ...
              <ol className="space-y-3 text-sm text-neutral-200">
                <li className="flex items-start gap-3">
                  <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-white/10 text-xs ring-1 ring-white/15">1</span>
                  Choose CSV or JSON file.
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-white/10 text-xs ring-1 ring-white/15">2</span>
                  Preview rows and confirm.
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-white/10 text-xs ring-1 ring-white/15">3</span>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <div className="space-y-4">
                <button onClick={() => scrollToSection('features')} className="block text-black hover:text-gray-600 text-lg tracking-tighter font-medium transition-colors">Features</button>
                <button onClick={() => scrollToSection('privacy')} className="block text-black hover:text-gray-600 text-lg tracking-tighter font-medium transition-colors">Privacy</button>
                <button onClick={() => scrollToSection('how-it-works')} className="block text-black hover:text-gray-600 text-lg tracking-tighter font-medium transition-colors">How it works</button>
                <button onClick={() => scrollToSection('export')} className="block text-black hover:text-gray-600 text-lg tracking-tighter font-medium transition-colors">Export data</button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <a href="mailto:help@jobsy.com" className="block text-black hover:text-gray-600 text-lg tracking-tighter font-medium transition-colors">help@jobsy.com</a>
                <a href="/privacy" className="block text-black hover:text-gray-600 text-lg tracking-tighter font-medium transition-colors">Privacy Policy</a>
                <a href="/terms" className="block text-black hover:text-gray-600 text-lg tracking-tighter font-medium transition-colors">Terms of Service</a>
                <a href="/status" className="block text-black hover:text-gray-600 text-lg tracking-tighter font-medium transition-colors">System Status</a>
              </div>
            </div>
          </div>
